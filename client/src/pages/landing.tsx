          ...
          <div className="grid gap-5 sm:grid-cols-2 max-w-3xl mx-auto">
            <motion.div initial="hidden" animate={pricingInView ? "visible" : "hidden"} variants={fadeUp} custom={2}>
              <TiltCard className="h-full rounded-3xl" maxTilt={5}>
                ...
                >
                  <Card
                    className="relative h-full overflow-hidden rounded-3xl border-0 bg-slate-950/80 text-slate-50 px-8 py-9 shadow-[0_24px_80px_rgba(15,23,42,0.85)]"
                    data-testid="card-pricing-free"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-slate-800/40 via-slate-900/70 to-black/80" />
                    <div className="relative flex h-full flex-col">
                      <div className="mb-6">
                        <h3 className="font-semibold text-sm uppercase tracking-[0.18em] text-slate-300 mb-2">Free</h3>
                        <div className="flex items-baseline gap-1">
                          <span className="text-4xl font-black tracking-tight">₩0</span>
                          <span className="text-sm text-slate-300">/월</span>
                        </div>
                        <p className="mt-2 text-xs text-slate-300">
                          가볍게 써보는 입문 플랜
                        </p>
                      </div>
                      <ul className="space-y-2.5 text-sm text-slate-100 mb-7">
                      ...
                      <Button
                        className="mt-auto w-full h-11 rounded-full border-slate-400/80 text-slate-50 bg-slate-900/20 hover:bg-slate-900/50"
                        size="lg"
                        variant="outline"
                        asChild
            ...
            <motion.div initial="hidden" animate={pricingInView ? "visible" : "hidden"} variants={fadeUp} custom={3}>
              <TiltCard className="h-full rounded-3xl" maxTilt={5}>
                ...
                >
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-white/12 via-transparent to-black/20 mix-blend-screen" />
                    <div className="relative flex h-full flex-col">
                      <div className="flex items-center justify-between mb-6">
                        <Badge className="bg-white/18 text-[11px] px-3 py-1 border border-white/30">Pro</Badge>
